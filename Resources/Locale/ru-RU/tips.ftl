...
tips-dataset-2 = Вы можете в любое время просмотреть и отредактировать все привязки клавиш, используемые в игре, через меню «Настройки».
tips-dataset-3 = Вы можете открыть внутриигровое Руководство через меню на клавишу Esc, или нажав клавишу Numpad-0 (по умолчанию).
...
tips-dataset-6 = Вы можете избежать поскальзывания на большинстве луж, если будете идти шагом (по умолчанию нужно зажать клавишу Shift). Однако некоторые сильные вещества, такие как космическая смазка, все равно заставят вас поскользнуться.
...
tips-dataset-19 = Если Сингулярность запущена, не забывайте периодически заправлять коллекторы радиации.
tips-dataset-20 = Химикаты не реагируют между собой, пока находятся в буфере ХимМастера.
tips-dataset-21 = Не зли бармена, не бросай стаканы! Вежливо ставь их на стол, нажимая Q.
...
tips-dataset-24 = Каждый член экипажа имеет в своем аварийном запасе экстренный медипен, содержищай эпинефрин и транексамовую кислоту.
...
tips-dataset-26 = Во время Теслалуза убедись, что избавился от всех электронных предметов, чтобы не стать мишенью Теслы.
...
tips-dataset-31 = Будучи предателем, вы можете использовать ключ шифрования синдиката для поддержания связи с любым другим, купившим ключ, предателем.
tips-dataset-32 = Будучи предателем, компрометирование важных каналов связи, таких как безопасность или инженерия, может дать ценную информацию. Помни, что это работает в обе стороны — безопасность также может заполучить ключи синдиката!
...
tips-dataset-36 = Будучи предателем, будь осторожен при использовании вестина из набора для химического синтеза. Если кто-то проверит твой ХимМастер, он может легко тебя выдать.
tips-dataset-37 = Будучи предателем, помните, что поглотители энергии издают громкий звук и оповещают экипаж после достаточно длительной работы. Попробуйте спрятать их в трудно-находимом месте или защитите область вокруг него, чтобы было труднее добратся.
tips-dataset-38 = Будучи предателем, помните, газообразная плазма — отличное средство для создания хаоса. Его можно поджечь, чтобы сделать территорию абсолютно непригодной для жизни, а также он может сильно отравить тех, кто его вдохнёт.
tips-dataset-39 = Будучи предателем, обезвоженные карпы могут быть крайне полезны для устранения больших толп людей. Также их использование может стать неплохим отвлекающим манёвром.
tips-dataset-40 = Будучи предателем, вы пробовали вводить плазму в батареи? В случае с дефибриллятором это приведёт к взрыву при использовании, нанося вред как пользователю, так и пациенту! Это опасный, но эффективный способ саботажа, если вы хотите создать хаос.
...
tips-dataset-44 = Будучи антагонистом, помните о силе разрушения телекоммуникаций. Людям будет гораздо сложнее поймать вас, если они не смогут общатся с другими на больших расстояниях!
...
tips-dataset-50 = Будучи утилизатором, не забывайте использовать крюк-пушку. Она может быть полезена для того, чтобы зацепиться за обломки или, если ты застрял в космосе, не полагаться на протокинетический ускоритель.
tips-dataset-51 = Совет #51 не существует и никогда не существовал. Игнорируйте любые слухи на этот счет.
...
tips-dataset-55 = Будучи грузчиком, если у вас есть излишек денег, попробуйте поиграть в азартные игры! Иногда можно выиграть больше, чем у вас было в начале. Однако будьте осторожны — азартные игры могут быстро вывести вас из равновесия!
...
tips-dataset-62 = Будучи Шеф-Поваром, ваш нож может стать оружием в экстренной ситуации. В случае угрозы или необходимости защиты, он может быть полезным для самозащиты, но всегда помните, что лучше избегать насилия, если это возможно.
tips-dataset-63 = Будучи Шеф-Поваром, вы можете подмешивать жидкости в свою еду. Будучи предателем, добавление немного аматоксина или другого яда может сильно раздражать экипаж!
...
tips-dataset-73 = Будучи инженером, всегда всё проверяйте дважды, когда настраиваете Сингулярность. Допустить её побег проще, чем вы думаете!
...
tips-dataset-80 = Будучи учёным, вы можете использовать улучшенные версии машин, чтобы повысить их эффективность. Это может значительно улучшить работу некоторых устройств; утилизаторы будут вам благодарны, если вы улучшите их переработчик руды!
tips-dataset-81 = Будучи учёным, вы можете создавать киборгов, используя позитронные мозги и корпус. Они так же полезны, как и новый член экипажа.
...
tips-dataset-84 = Будучи врачом, будьте осторожны при помещении унатхов в криокапсулы. Они получат много дополнительного урона от холода, но вы всегда сможете смягчить это с помозью мази или лепоразина.
tips-dataset-85 = Будучи врачом, помните, что анализатор здоровья можно использовать, если вы потеряете свой КПК. Однако у него есть батарея, и если она быстро разряжается, вы можете попросить учёных напечатать для вас лучшую батарею!
...
tips-dataset-88 = Не бойтесь просить о помощи, будь то у ваших коллег по отделу, или через LOOC-чат, или у Кураторов!
...
tips-dataset-95 = В экстренной ситуации не забывайте, что пожарные и аварийные EVA скафандры всегда находятся в соответствующих шкафчиках. В них может быть неудобно передвигаться, но они могут легко спасти вам жизнь в плохой ситуации!
tips-dataset-96 = В экстренной ситуации помните, что вы можете создать импровизированое оружие! Бейсбольная бита или копьё могут легко стать решающим фактором между отпугиванием нападающего и гибелью от его рук.
...
tips-dataset-98 = Вы можете создать копья с осколков армированного, плазменного и уранового стекла для увеличения урона.
...
tips-dataset-101 = Вы можете бросать созданные болы в людей, для того чтобы замедлить их, позволяя вам преследовать для прощего убийства или для быстрого ухода.
...
tips-dataset-104 = Как и в любой другой работе, кроме утилизатора, обычно разумно избегать использование скафандров, если они вам не нужны, поскольку замедленние, которое они вызывают, часто гораздо более вредно, чем любое сопротивление или защита от космоса, которое вы можете получить.
...
tips-dataset-116 = Кровотечение не шутка! Если вас посдтрелили или вы получили другую серьёзную травму, позаботьтесь о том, чтобы быстро её вылечить.
...
tips-dataset-126 = Если вы не человек или моль, вы можете пить кровь, для восстановления некоторого количества своего кровотока, хоть и неэффективно.
tips-dataset-127 = Если вы человек или моль, не пейте кровь! Из-за этого вы можете отравиться и будете получать урон.
...
tips-dataset-134 = Вы можете определить, разгерметизирована ли область с пожарными замками, посмотря, есть ли у пожарных замков кроме них огни.
